    ...
    <main className="max-w-7xl mx-auto px-4 py-16">
      ...
      <article className="grid md:grid-cols-2 gap-8 mb-16">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg leading-relaxed first-letter:text-5xl first-letter:font-serif first-letter:mr-3 first-letter:float-left">
            Nestled in the heart of our region, Okeogboran stands as a testament
            to time, where traditional values seamlessly blend with modern
            progress. Our town, with its historic architecture and vibrant
            community, continues to charm visitors and residents alike.
          </p>
          <blockquote className="border-l-4 border-primary pl-4 italic my-8">
            &apos;Okeogboran represents the perfect harmony between preserving
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <section className="space-y-4">
          ...
          <p className="leading-relaxed">
            Situated in a picturesque valley, Okeogboran enjoys a mild climate
            year-round. The surrounding hills provide breathtaking views and
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed">
            Our close-knit community takes pride in maintaining strong bonds
            through various cultural events, festivals, and regular town
            gatherings.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed">
            Throughout the year, Okeogboran hosts numerous events that celebrate
            our heritage, from traditional festivals to modern art exhibitions.
          </p>
        </section>
      </div>
      ...
      <article className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <p className="leading-relaxed">
            The people of Okeogboran maintain a rich tapestry of cultural
            traditions that have been passed down through generations. From our
            annual harvest festival to the monthly community gatherings, these
            customs form the backbone of our social fabric.
          </p>
          <p className="leading-relaxed">
            Our town takes special pride in its traditional crafts, particularly
            in weaving and pottery. Local artisans continue to practice these
            age-old skills, creating pieces that are both functional and
            beautiful, attracting collectors from around the region.
          </p>
        </div>
        {/* Video Section */}
      ...
      <article className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-100 dark:bg-gray-700 p-4 mb-6 rounded-lg mt-6">
            <p className="mb-2">
              There are 4 segments of the ODERU descendants as follows:
            </p>
            <h4 className="font-bold mt-2">
              (A) DESCENDANT OF ITAGUN FAMUWAGUN: FATUNMO / OREBISOLA / ADEBAYO
              / UMORU FELE
            </h4>
          ...
          <div className="bg-gray-100 dark:bg-gray-700 p-4 mb-6 rounded-lg mt-6">
            ...
            <ul className="list-disc list-inside space-y-2 dark:text-gray-200">
              <li>ADELEYE</li>
              <li>
                FABORODE - ISAAC / AYIKITIWOLEOWO / ALHAJISANNI / OGUNLA /
                HEZEKIAH / AMUSA / OGUNSADE SAMSON
              </li>
              <li>FAPARUSI</li>
              <li>FAPESE</li>
              <li>FAMUBO</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-100 dark:bg-gray-700 p-4 mb-6 rounded-lg mt-6">
            ...
            <p className="font-bold mt-2">
              (B) OMOEKUN: HE HAD 11 MALE CHILDREN MADE OF PROMINENT SONS AND
              GRANDSONS:
            </p>
            ...
            <p className="mt-2 mb-2 pl-10">
              ALADETUYI (FATHER OF SAMUEL IDOWU)
            </p>
            <ul className="list-disc list-inside space-y-2 dark:text-gray-200">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed">
            The town council meets regularly to discuss and implement
            initiatives that benefit our community. Recent projects include the
            renovation of the historic town square and improvements to public
            transportation.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed">
            Our schools maintain high academic standards while incorporating
            local history and cultural education into their curriculum. The
            community library serves as a hub for learning and cultural
            exchange.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed">
            Local businesses continue to thrive, with a focus on sustainable
            practices and community support. The weekly market remains a
            centerpiece of our economic activity.
          </p>
        </div>
      </div>
    </main>
